          ...
          <div className="flex gap-5 items-center">
            ...
            >
              <img
                ...
                style={{
                  filter:
                    "invert(38%) sepia(85%) saturate(1015%) hue-rotate(357deg) brightness(98%) contrast(97%)",
                }} // Adjust color using CSS filter
              />
            </a>
            <a
            ...
            >
              <img
                ...
                style={{
                  filter:
                    "invert(31%) sepia(15%) saturate(392%) hue-rotate(176deg) brightness(96%) contrast(96%)",
                }} // Adjust color using CSS filter
              />
            </a>
            <a
            ...
            >
              <img
                ...
                style={{
                  filter:
                    "invert(34%) sepia(65%) saturate(483%) hue-rotate(206deg) brightness(96%) contrast(93%)",
                }} // Adjust color using CSS filter
              />
            </a>
            <a
            ...
            >
              <img
                ...
                style={{
                  filter:
                    "invert(53%) sepia(71%) saturate(532%) hue-rotate(187deg) brightness(99%) contrast(91%)",
                }} // Adjust color using CSS filter
              />
            </a>
          </div>
